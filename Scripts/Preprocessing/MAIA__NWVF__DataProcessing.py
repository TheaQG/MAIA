'''
    This script processes the ERA5 data for the vertical integral of the northward water vapour flux
    (NWVF) at 70N between 45W and 45E. The data is processed for the period 1994-2022 and saved as a
    new .nc file. 
    The script also includes a function to plot a single time step of the data.

    NEED TO MOVE THE DATA INTO THIS DIR BEFORE IT CAN RUN.
'''
...
file_pattern = os.path.join(path_raw, 'ERA5_download__vertical_integral_of_northward_water_vapour_flux_*__6hr_mean.nc')
