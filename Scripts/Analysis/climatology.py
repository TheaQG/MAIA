...
DATA_PATH = '../../Data/Processed_MAIA/'
FIG_PATH = '../../Figures/ObsResults/ERA5/Climatology/'

# Load NWVF data, filtered to match aerosol data
nwvf_EC_Villum = pd.read_csv(DATA_PATH + 'nwvf_EC_Villum.csv', index_col=0, parse_dates=True)
nwvf_EC_Zeppelin = pd.read_csv(DATA_PATH + 'nwvf_EC_Zeppelin.csv', index_col=0, parse_dates=True)
nwvf_SO4_Villum = pd.read_csv(DATA_PATH + 'nwvf_SO4_Villum.csv', index_col=0, parse_dates=True)
nwvf_SO4_Zeppelin = pd.read_csv(DATA_PATH + 'nwvf_SO4_Zeppelin.csv', index_col=0, parse_dates=True)

# Load aerosol dataframes
df_EC_Villum = pd.read_csv(DATA_PATH + 'df_EC_Villum.csv', index_col=0, parse_dates=True)
df_EC_Zeppelin = pd.read_csv(DATA_PATH + 'df_EC_Zeppelin.csv', index_col=0, parse_dates=True)
df_SO4_Villum = pd.read_csv(DATA_PATH + 'df_SO4_Villum.csv', index_col=0, parse_dates=True)
df_SO4_Zeppelin = pd.read_csv(DATA_PATH + 'df_SO4_Zeppelin.csv', index_col=0, parse_dates=True)
...
nwvf_ts_raw = pd.read_csv(DATA_PATH + 'nwvf_ts.csv', index_col=0, parse_dates=True)
...
if SAVE_FIG:
    fig.savefig(FIG_PATH + 'nwvf_raw_filtered_rolling.png', dpi=600, bbox_inches='tight')
...
# Weekly climatology
nwvf_ts_clim_week = nwvf_ts.groupby(nwvf_ts.index.isocalendar().week).mean()
nwvf_ts_clim_week_std = nwvf_ts.groupby(nwvf_ts.index.isocalendar().week).std()
...
if SAVE_FIG:
    fig.savefig(FIG_PATH + 'nwvf_climatology__M_W_D.png', dpi=600, bbox_inches='tight')
plt.show()
...
if SAVE_FIG:
    if WITH_ERRORBARS:
        fig.savefig(FIG_PATH + 'nwvf_aerosol_climatology_monthly_with_errorbars.png', dpi=600, bbox_inches='tight')
    else:
        fig.savefig(FIG_PATH + 'nwvf_aerosol_climatology_monthly.png', dpi=600, bbox_inches='tight')
#plt.show()
...
# NWVF (groupby week)
nwvf_EC_Villum_clim = nwvf_EC_Villum.groupby(nwvf_EC_Villum.index.isocalendar().week).mean()
nwvf_EC_Villum_clim_std = nwvf_EC_Villum.groupby(nwvf_EC_Villum.index.isocalendar().week).std()
nwvf_EC_Zeppelin_clim = nwvf_EC_Zeppelin.groupby(nwvf_EC_Zeppelin.index.isocalendar().week).mean()
nwvf_EC_Zeppelin_clim_std = nwvf_EC_Zeppelin.groupby(nwvf_EC_Zeppelin.index.isocalendar().week).std()
nwvf_SO4_Villum_clim = nwvf_SO4_Villum.groupby(nwvf_SO4_Villum.index.isocalendar().week).mean()
nwvf_SO4_Villum_clim_std = nwvf_SO4_Villum.groupby(nwvf_SO4_Villum.index.isocalendar().week).std()
nwvf_SO4_Zeppelin_clim = nwvf_SO4_Zeppelin.groupby(nwvf_SO4_Zeppelin.index.isocalendar().week).mean()
nwvf_SO4_Zeppelin_clim_std = nwvf_SO4_Zeppelin.groupby(nwvf_SO4_Zeppelin.index.isocalendar().week).std()

# Aerosol (groupby week)
df_EC_Villum_clim = df_EC_Villum.groupby(df_EC_Villum.index.isocalendar().week).mean()
df_EC_Villum_clim_std = df_EC_Villum.groupby(df_EC_Villum.index.isocalendar().week).std()
df_EC_Zeppelin_clim = df_EC_Zeppelin.groupby(df_EC_Zeppelin.index.isocalendar().week).mean()
df_EC_Zeppelin_clim_std = df_EC_Zeppelin.groupby(df_EC_Zeppelin.index.isocalendar().week).std()
df_SO4_Villum_clim = df_SO4_Villum.groupby(df_SO4_Villum.index.isocalendar().week).mean()
df_SO4_Villum_clim_std = df_SO4_Villum.groupby(df_SO4_Villum.index.isocalendar().week).std()
df_SO4_Zeppelin_clim = df_SO4_Zeppelin.groupby(df_SO4_Zeppelin.index.isocalendar().week).mean()
df_SO4_Zeppelin_clim_std = df_SO4_Zeppelin.groupby(df_SO4_Zeppelin.index.isocalendar().week).std()
...
if SAVE_FIG:
    if WITH_ERRORBARS:
        fig.savefig(FIG_PATH + 'nwvf_aerosol_climatology_weekly_with_errorbars.png', dpi=600, bbox_inches='tight')
    else:
        fig.savefig(FIG_PATH + 'nwvf_aerosol_climatology_weekly.png', dpi=600, bbox_inches='tight')
...
if SAVE_FIG:
    if WITH_ERRORBARS:
        fig.savefig(FIG_PATH + 'nwvf_aerosol_climatology_daily_with_errorbars.png', dpi=600, bbox_inches='tight')
    else:
        fig.savefig(FIG_PATH + 'nwvf_aerosol_climatology_daily.png', dpi=600, bbox_inches='tight')
