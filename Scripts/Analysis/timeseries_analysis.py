...
PATH_DATA = '../../Data/'
PATH_FIGS = '../../Figures/TimeseriesAnalysis/' + aerosol_str + '/'
...
class EventAnalysis:
    ...
    def plot_events(self, bins_nwvf=32, bins_aerosol=32, show_figs=True, save_figs=False, save_path=None, plot_events_pos=True,
                    plot_events_neg=True):
        '''
            Plot the masked aerosol and nwvf data in histograms.
        '''
        ...
        # fig.suptitle(f'{self.aerosol_name}, +/- {self.n_sigmas} $\sigma$ events')
            
            
        # # NWVF DATA PLOT
        

        # ax[0].hist(self.nwvf_data[self.nwvf_name],
        #             bins=bins_nwvf,
        #             alpha=0.9,
...
# Try the EventAnalysis class with a single aerosol and NWVF anomaly data
# Define the aerosol and NWVF data




aero_anom = aerosol_anomaly_dfs[0]
nwvf_anom = NWVF_anomalies

# Create an EventAnalysis object
event_analysis = EventAnalysis(aero_anom, 'anomaly', nwvf_anom, 'anomaly', n_sigmas=2)

# Plot the data
fig, (ax1, ax2) = event_analysis.plot_all_data(bins_nwvf=32, bins_aerosol=32, show_figs=True, save_figs=False, save_path=None, plot_events_pos=True,
                        plot_events_neg=True)
